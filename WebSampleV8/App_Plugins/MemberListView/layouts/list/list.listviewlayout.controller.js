(function () {
    ...
    function ListViewListLayoutController($scope, listViewHelper, mediaHelper, mediaTypeHelper, editorService) {
        ...
        function clickItem(item) {
            ...
            editorService.open(memberEditor)
        }
    ...
    angular.module("umbraco").controller("MemberListView.PropertyEditors.ListView.ListLayoutController", ListViewListLayoutController);
